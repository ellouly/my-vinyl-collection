 ...
 */
final class Version20200625093606 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE album (id INT AUTO_INCREMENT NOT NULL, artist_id INT NOT NULL, category_id INT NOT NULL, name VARCHAR(255) NOT NULL, year INT DEFAULT NULL, image VARCHAR(255) NOT NULL, titles VARCHAR(255) NOT NULL, link_audio VARCHAR(255) NOT NULL, INDEX IDX_39986E43B7970CF8 (artist_id), INDEX IDX_39986E4312469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
